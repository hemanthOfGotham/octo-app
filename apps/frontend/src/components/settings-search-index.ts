...
export const settingsSearchIndex: SettingsSearchEntry[] = [
	...
	},
	{
		...
		section: 'General Settings',
		title: 'Theme',
		description: 'Choose how Octo looks.',
	...
	// ── Project > Agent ──────────────────────────────────────
	{
		...
		description: 'Memories enable Octo to remember preferences and facts about team members.',
	...
	// ── Project > MCP Servers ────────────────────────────────
	{
		...
		title: 'MCP Servers',
		description: 'Integrate MCP servers to extend the capabilities of Octo.',
